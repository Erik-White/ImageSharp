...
internal static class Av1DefaultDistributions
{
    ...
    /// <summary>
    /// Gets the palette Y-size <see cref="Av1Distribution"/>, indexed by [bsize_ctx]. Symbol value is palette_size - 2.
    /// </summary>
    /// <remarks>libaom: default_palette_y_size_cdf.</remarks>
    ...
    /// <summary>
    /// Gets the palette UV-size <see cref="Av1Distribution"/>, indexed by [bsize_ctx]. Symbol value is palette_size - 2.
    /// </summary>
    /// <remarks>libaom: default_palette_uv_size_cdf.</remarks>
    ...
    /// <summary>
    /// Gets the palette Y color-index <see cref="Av1Distribution"/>, indexed by [palette_size - 2][color_ctx].
    /// </summary>
    /// <remarks>libaom: default_palette_y_color_index_cdf.</remarks>
    public static Av1Distribution[][] PaletteYColorIndex =>
        [
            ...
            [
                new(27877, 30490), new(11532, 25697), new(6544, 30234),
                new(23018, 28072), new(31915, 32385)
            ],
            [
                new(25572, 28046, 30045), new(9478, 21590, 27256), new(7248, 26837, 29824),
                new(19167, 24486, 28349), new(31400, 31825, 32250)
            ],
            [
                new(24779, 26955, 28576, 30282), new(8669, 20364, 24073, 28093), new(4255, 27565, 29377, 31067),
                new(19864, 23674, 26716, 29530), new(31646, 31893, 32147, 32426)
            ],
            [
                new(23132, 25407, 26970, 28435, 30073), new(7443, 17242, 20717, 24762, 27982), new(6300, 24862, 26944, 28784, 30671),
                new(18916, 22895, 25267, 27435, 29652), new(31270, 31550, 31808, 32059, 32353)
            ],
            [
                new(23105, 25199, 26464, 27684, 28931, 30318), new(6950, 15447, 18952, 22681, 25567, 28563), new(7560, 23474, 25490, 27203, 28921, 30708),
                new(18544, 22373, 24457, 26195, 28119, 30045), new(31198, 31451, 31670, 31882, 32123, 32391)
            ],
            [
                new(21689, 23883, 25163, 26352, 27506, 28827, 30195), new(6892, 15385, 17840, 21606, 24287, 26753, 29204), new(5651, 23182, 25042, 26518, 27982, 29392, 30900),
                new(19349, 22578, 24418, 25994, 27524, 29031, 30448), new(31028, 31270, 31504, 31705, 31927, 32153, 32392)
            ]
        ];

    /// <summary>
    /// Gets the palette UV color-index <see cref="Av1Distribution"/>, indexed by [palette_size - 2][color_ctx].
    /// </summary>
    /// <remarks>libaom: default_palette_uv_color_index_cdf.</remarks>
    public static Av1Distribution[][] PaletteUvColorIndex =>
        [
            ...
            [
                new(25257, 29145), new(12287, 27293), new(7033, 27960),
                new(20145, 25405), new(30608, 31639)
            ],
            [
                new(24210, 27175, 29903), new(9888, 22386, 27214), new(5901, 26053, 29293),
                new(18318, 22152, 28333), new(30459, 31136, 31926)
            ],
            [
                new(22980, 25479, 27781, 29986), new(8413, 21408, 24859, 28874), new(2257, 29449, 30594, 31598),
                new(19189, 21202, 25915, 28620), new(31844, 32044, 32281, 32518)
            ],
            [
                new(22217, 24567, 26637, 28683, 30548), new(7307, 16406, 19636, 24632, 28424), new(4441, 25064, 26879, 28942, 30919),
                new(17210, 20528, 23319, 26750, 29582), new(30674, 30953, 31396, 31735, 32207)
            ],
            [
                new(21239, 23168, 25044, 26962, 28705, 30506), new(6545, 15012, 18004, 21817, 25503, 28701), new(3448, 26295, 27437, 28704, 30126, 31442),
                new(15889, 18323, 21704, 24698, 26976, 29690), new(30988, 31204, 31479, 31734, 31983, 32325)
            ],
            [
                new(21442, 23288, 24758, 26246, 27649, 28980, 30563), new(5863, 14933, 17552, 20668, 23683, 26411, 29273), new(3415, 25810, 26877, 27990, 29223, 30394, 31618),
                new(17965, 20084, 22232, 23974, 26274, 28402, 30390), new(31190, 31329, 31516, 31679, 31825, 32026, 32322)
            ]
        ];

    /// <summary>
    /// Gets the lookup table mapping the palette color-index context hash (0..MAX_COLOR_CONTEXT_HASH) to the
    /// 0..PALETTE_COLOR_INDEX_CONTEXTS-1 CDF index. Negative entries are unreachable hashes.
    /// </summary>
    /// <remarks>libaom: av1_palette_color_index_context_lookup.</remarks>
    public static int[] PaletteColorIndexContextLookup =>
        [-1, -1, 0, -1, -1, 4, 3, 2, 1];
