...
internal static class Av1ScanOrderConstants
{
    ...
    // Spec 9.2: Default_Scan_WxH values, row-major (pos = width * y + x). The spec lists the
    // non-square scans in explicit transpose pairs (e.g. Default_Scan_4x8 / Default_Scan_8x4),
    // each table below is the spec's own WxH table read in that row-major order.
    ...
    // Spec 9.2: Default_Scan_8x16, row-major (pos = 8 * y + x).
    ...
    // Spec 9.2: Default_Scan_16x32, row-major (pos = 16 * y + x).
    ...
    // Spec 9.2: Default_Scan_4x16, row-major (pos = 4 * y + x).
    ...
    // Spec 9.2: Default_Scan_8x32, row-major (pos = 8 * y + x).
